<%@ Page Title="Yazarlar" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="Yazarlar.aspx.cs" Inherits="ETicaretSitesiStaj.Yazarlar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="m-1">
        <div class="container my-4">
            <div class="row">
                <!-- yazarlar solda listenin oldugu kısım-->
                <div class="navbar-nav col-md-2 my-2">
                    <div class="container-fluid shadow-lg filtercerceve bgmyfilter" style="height: auto; word-break: break-word;">
                        <div class="row centerr">
                            <asp:Label CssClass="labeltxtdropSize my-1" ID="lblSearchSabit" runat="server" Text="Yazarlar" Font-Bold="true" Font-Size="X-Large" Font-Underline="true" Font-Italic="true"></asp:Label>
                            <br />
                            <asp:DataList CssClass="my-3" ID="DataListYazarliste" runat="server">
                                <ItemTemplate>
                                    <div>
                                        <a href="Yazarlar.aspx?yaz=<%# Eval("Yazarid") %>">
                                            <asp:Label ID="Label1" CssClass="shadowtxt ml-1" runat="server" Text='<%# Eval("YazarAdiSoyadi") %>' Style="font-weight: 600; font-size: 17px; color: black"></asp:Label>
                                        </a>
                                    </div>
                                </ItemTemplate>
                            </asp:DataList>
                ...
                <!--/yazarlar solda listenin oldugu kısım-->
                <!-- yazarlar sağda kitapların listelendiği kısım-->
                <div class="navbar navbar-nav navbar-expand-md navbar-dark col-md-10 mb-2 pl-2">
                    <div class="row shadow pl-1 ml-1 bgmyicerik border20p" style="min-height: 830px; width: 937px; border: 2px solid #a1a1a1; word-break: break-all;">
                        <div class="container golgeliKutu3 mr-1 bordertop20" style="height: 60px;">
                            <div class="p-1 mr-auto">
                                <asp:Label ID="lblYazarlarListesi" runat="server" Style="font-size: x-large; color: black;" Text="Kitapların Listesi"></asp:Label>
                            </div>
                            <div class="ml-auto">
                                <div class="container">
                        ...
                        <div class="row navbar-expand-md m-2 mt-3" style="min-height: 743px;">
                            <asp:DataList RepeatDirection="Horizontal" RepeatColumns="4" ID="DataListYazarlar" runat="server">
                                <ItemTemplate>
