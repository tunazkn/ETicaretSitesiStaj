<%@ Page Title="Kullanıcı - Hakkımızda" Language="C#" MasterPageFile="~/User/Kullanici.Master" AutoEventWireup="true" CodeBehind="UHakkimizda.aspx.cs" Inherits="ETicaretSitesiStaj.User.UHakkimizda" %>
            ...
            <div class="row">
                <div class="row shadow bgmyicerik border20p my-2 mx-1 px-5 py-3" style="border: 2px solid #a1a1a1;">
                    ...
                    <hr class="w-100 p-2" />
                        <h4>Biz Kimiz? </h4>
                        <p>
                            İddialıyız, en “taze eserler” burada!
                        <br />
