<%@ Page Title="Kullanıcı - Anasayfa" Language="C#" MasterPageFile="~/User/Kullanici.Master" AutoEventWireup="true" CodeBehind="UAnasayfa.aspx.cs" Inherits="ETicaretSitesiStaj.User.UAnasayfa" %>
                    ...
                    <div class="amazingslider" id="amazingslider-1" style="display: block; position: relative; margin: 0 auto;">
                        <ul class="amazingslider-slides" style="display: none;">
                            <li>
                                ...
                                <a href="UKitapDetay.aspx?Kitapid=2" class="btn btn-outline-info hvr-float-shadow" target="_blank">
                            ...
                            <li>
                                ...
                                <a href="UKitapDetay.aspx?Kitapid=1" class="btn btn-outline-info hvr-float-shadow" target="_blank">
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                    Detaylar
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                </a>
                            ...
                            <li>
                                ...
                                <a href="UKitapDetay.aspx?Kitapid=4" class="btn btn-outline-info hvr-float-shadow" target="_blank">
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                    Detaylar
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                </a>
                            ...
                            <li>
                                ...
                                <a href="UKitapDetay.aspx?Kitapid=3" class="btn btn-outline-info hvr-float-shadow" target="_blank">
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                    Detaylar
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                </a>
                            ...
                            <li>
                                ...
                                <a href="UKitapDetay.aspx?Kitapid=16" class="btn btn-outline-info hvr-float-shadow" target="_blank">
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                    Detaylar
                                    <button class="amazingsliderbutton btn" disabled="disabled" style="width: 1px;"></button>
                                </a>
                ...
                <div class="container navbar navbar-expand-md navbar-dark filtercerceve0 bgmyicerik">
                    <div class="row">
                        ...
                        <div class="navbar navbar-expand-md navbar-dark">
                            <div class="row shadow border20p mr-0" style="border: 1px solid black; float: left; word-break: break-all;">
                                <div class="container">
                        ...
                        <hr style="border: 1px solid #a1a1a1; margin-left: 15px; width: 97%;" />
