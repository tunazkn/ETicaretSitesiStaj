<%@ Page Title="Kullanıcı - Yayınevleri" Language="C#" MasterPageFile="~/User/Kullanici.Master" AutoEventWireup="true" CodeBehind="UYayinevleri.aspx.cs" Inherits="ETicaretSitesiStaj.User.UYayinevleri" %>
                    ...
                    <div class="container-fluid shadow-lg filtercerceve bgmyfilter" style="height: auto; word-break: break-word;">
                        <div class="row centerr">
                            ...
                            <asp:DataList CssClass="my-3" ID="DataListYayınevliste" runat="server">
                                <ItemTemplate>
                                    <div>
                                        <a href="UYayinevleri.aspx?yev=<%# Eval("Yayineviid") %>">
