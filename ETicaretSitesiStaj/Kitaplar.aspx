<%@ Page Title="Kitaplar" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="Kitaplar.aspx.cs" Inherits="ETicaretSitesiStaj.Kitaplar" %>
                ...
                <div class="navbar-nav filtercerceve shadow col-md-2 my-2 bgmyfilter">
                    <div class="container-fluid" style="height: auto; word-break: break-word;">
                        <div class="row centerr">
                            <asp:Label CssClass="labeltxtdropSize my-1" ID="lblSearchSabit" runat="server" Text="Filtre" Font-Bold="true" Font-Size="X-Large" Font-Italic="true"></asp:Label>
                            <br />
                    ...
                    <div class="row shadow pl-1 ml-1 bgmyicerik border20p" style="min-height: 600px; width: 937px; border: 2px solid #a1a1a1; word-break: break-all;">
                        <div class="container golgeliKutu3 mr-1 bordertop20" style="height: 90px;">
                            <div class="container mt-2">
                                <div class="my-1" style="padding: 1px 1px 1px 1px; height: 30px; word-break: break-word;">
                                    <asp:Label CssClass="ml-1" ID="Label3" runat="server" Visible="false" Text="Seçilen: "></asp:Label>
                                    <asp:Label CssClass="ml-1 text-break" ID="lblfiltreisimleri" runat="server" Visible="false" Text="."></asp:Label>
                                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="mt-1">
                                                        ...
                                                        <asp:Button CssClass="btn btn-outline-success p-1" ID="btnSepeteEkle" Style="text-align: center;" runat="server" title="Sepete Ekle" Text="Sepete Ekle" OnClick="btnSepeteEkle_Click" />
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
